...
const TRANSLATIONS = {
  en: {
    ...
    // Goals
    'matchday.jumpLabel':     'min',
    'matchday.jumpGo':        'Go',
    'matchday.timeline':      'Match Timeline',
    'matchday.noEvents':      'No events yet',
    'matchday.summaryBtn':    '📋 Summary',
    'matchday.summaryTitle':  'Match Summary',
    'matchday.exportPng':     '📥 Save PNG',
    'matchday.ourGoalBtn':    '⚽ Our Goal',
    'matchday.theirGoalBtn':  '⚽ Their Goal',
    'matchday.ourGoalTitle':  'Our Goal ⚽',
    'matchday.theirGoalTitle':'Opponent Goal ⚽',
    'matchday.goalScorer':    'Goal Scorer',
    'matchday.assister':      'Assister (optional)',
    'matchday.noAssist':      'No assist',
    'matchday.confirmGoal':   '⚽ Confirm Goal',
    'matchday.selectScorer':  'Please select the goal scorer.',
    'matchday.goalUs':        '⚽ Goal!',
    'matchday.goalThem':      'Opponent scored.',
    'matchday.theirGoalLabel':'Opponent',
    'matchday.us':            'Us',
    'matchday.them':          'Opponent',
  },
  he: {
    // App name & header
    'app.name':       'רוטקטיקה',
    ...
    // Goals
    'matchday.jumpLabel':     'דק׳',
    'matchday.jumpGo':        'קפוץ',
    'matchday.timeline':      'ציר זמן משחק',
    'matchday.noEvents':      'אין אירועים עדיין',
    ...
    'matchday.goalScorer':    'מבקיע',
    'matchday.assister':      'מבשל (אופציונלי)',
    'matchday.noAssist':      'ללא בישול',
    'matchday.confirmGoal':   '⚽ אשר שער',
    'matchday.selectScorer':  'יש לבחור מבקיע.',
    'matchday.goalUs':        '!⚽ שער',
    'matchday.goalThem':      'היריב הבקיע.',
    'matchday.theirGoalLabel':'יריב',
    'matchday.us':            'אנחנו',
    'matchday.them':          'יריב',
  }
};
